...
public class ColorPickerDialogBuilder {
    ...
    public AlertDialog build() {
        ...
        if (isColorEditEnabled) {
            ...
            LinearLayout mehsancoder = (LinearLayout) ipm.inflate(R.layout.hi100, null, false);
            LinearLayout.LayoutParams params =
                    new LinearLayout.LayoutParams(
                            LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
            mehsancoder.setLayoutParams(params);
            com.google.android.material.textfield.TextInputLayout inputLayout =
                    mehsancoder.findViewById(R.id.inputLayout);
            com.google.android.material.textfield.TextInputEditText colorEdit =
                    mehsancoder.findViewById(R.id.colorEdit);
            LinearLayout layout = mehsancoder.findViewById(R.id.layout);
            ...
            pickerContainer.addView(mehsancoder);
        }
        if (isPreviewEnabled) {
