...
public class G4Compiler {
      ...
      antlr.addListener(
          new ANTLRToolListener() {
            ...
            public void error(ANTLRMessage error) {
              ...
              builder.append("Code by nexzo ide").append('\n');
              ...
              FileUtil.writeFile(
                  "/storage/emulated/0/nexzoWebIDE/antlrgrammererr.log", builder.toString());
            }
            ...
            public void warning(ANTLRMessage error) {
              ...
              showToast(builder.toString());
              FileUtil.writeFile(
                  "/storage/emulated/0/nexzoWebIDE/antlrgrammerwar.log", builder.toString());
            }
          });
  ...
  static void showToast(String s) {
    Toast.makeText(nexzoIdeAppLoader.getContext(), s, 2).show();
  }
}
