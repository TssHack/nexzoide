...
import ir.ehsancoder.nexzoide.compressor.SvgToPng;
...
import ir.ehsancoder.nexzoide.utils.SvgShow;
...
public class IconModActivity extends BaseCompat {
  ...
  public void itemList() {
    listDir.clear();
    ListMap.clear();
    path = "/storage/emulated/0/nexzoWebIDE/.icon";
  ...
  public void _msvgtopng(final String _svg, final String _pngss) {
    AlertDialog dialog =
        new nexzoWebMaterialDialog(IconModActivity.this)
                                ...
                                new OnMenuItemClickListener<PowerMenuItem>() {
                                  ...
                                  public void onItemClick(int position, PowerMenuItem item) {
                                    switch ((int) position) {
                                      case ((int) 0):
                                        {
                                          output = "/sdcard/nexzoweb/icon/vector/";
                                      ...
                                      case ((int) 1):
                                        {
                                          if (!FileUtil.isDirectory("/sdcard/nexzoweb/icon/svg")) {
                                            FileUtil.makeDir("/sdcard/nexzoweb/icon/svg");
                                          }
                                      ...
                                      case ((int) 2):
                                        {
                                          if (!FileUtil.isDirectory("/sdcard/nexzoweb/icon/png")) {
                                            FileUtil.makeDir("/sdcard/nexzoweb/icon/png");
                                          }
                                          _msvgtopng(
