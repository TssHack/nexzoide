...
import ir.ehsancoder.nexzoide.databinding.ThemepreviewLayoutBinding;
import ir.ehsancoder.nexzoide.model.LoadTheme;
import ir.ehsancoder.nexzoide.utils.FileUtil;
import ir.ehsancoder.nexzoide.utils.KeySet;
...
public class ThemePreviewActivity extends BaseCompat {
  ...
  private String getNewTextForItem(String item) {
    switch (item) {
      case "ehsancoder.java":
        bind.editor.setEditorLanguage(new JavaLanguage(bind.editor));
        return """
               import java.io.File;
               import android.util.Log;

                public class ehsancoder extends AppCompatActivity {
      ...
      case "Rubypy.js":
        ...
        return """
            ...
            function it() {
                ...
                """;
      case "termuxitem.sh":
        bind.editor.setEditorLanguage(new ehsanLang());
        return """
                #! /bin/bash
