...
import ir.ehsancoder.nexzoide.utils.EdgeToEdgeUtils;
import ir.ehsancoder.nexzoide.utils.ObjectUtils;
import ir.ehsancoder.nexzoide.utils.FileUtil;
import ir.ehsancoder.nexzoide.utils.ReSizeApp;
...
public class BaseCompat extends AppCompatActivity {
  ...
  protected static String packApp = "ir.ehsancoder.nexzoide";
  ...
  private static String ThemePath = "/storage/emulated/0/nexzoWebIDE/theme/nexzoThemeapp.nexzo";
  ...
  public void ThemeChaker() {
    try {
      ...
      var themeeuda =
        ...
        """;
      if (!FileUtil.isExistFile("/storage/emulated/0/nexzoWebIDE/theme/erudatheme.json")) {

        FileIOUtils.writeFileFromString(
            "/storage/emulated/0/nexzoWebIDE/theme/erudatheme.json", themeeuda);
      }
