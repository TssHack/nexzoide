...
import ir.ehsancoder.nexzoide.PluginManager.ModelPackage.PackageAd;
import ir.ehsancoder.nexzoide.PluginManager.ModelPackage.PackageModels;
import ir.ehsancoder.nexzoide.PluginManager.ModelPackage.WorkPackageManager;
import ir.ehsancoder.nexzoide.R;
import ir.ehsancoder.nexzoide.marco.HsiZip;
...
public class PluginManagerActivity extends BaseCompat {
  ...
  private void initializeLogic() {
    ...
    //// data/user/0/ir.ehsancoder.nexzoide/files/lib
    if (FileUtil.isExistFile(
        getFilesDir().getAbsolutePath()
            + File.separator
            + "files"
