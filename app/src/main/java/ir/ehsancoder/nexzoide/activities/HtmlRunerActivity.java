...
import ir.ehsancoder.nexzoide.ServerHost;
import ir.ehsancoder.nexzoide.databinding.HtmlrunerBinding;
...
public class HtmlRunerActivity extends BaseCompat {
  ...
  public void setDesktopMode(boolean _isChecked) {
   ...
   void _searchData() {
    AlertDialog dialog =
        new nexzoWebMaterialDialog(HtmlRunerActivity.this)
  ...
  void reloadConsoleJs() {
    ...
    Map<String, String> mapcolor =
        new Gson()
            .fromJson(
                FileUtil.readFile("/storage/emulated/0/nexzoWebIDE/theme/erudatheme.json"),
                new TypeToken<Map<String, String>>() {}.getType());
    boolean isThemeFile =
        FileUtil.isExistFile("/storage/emulated/0/nexzoWebIDE/theme/erudatheme.json");
    if (theme == ErudaThemes.nexzo) {
      if (isThemeFile)
        js =
            "(function(){"
  ...
  public void JsConsoleBeta() {
    ...
    imap =
        new Gson()
            .fromJson(
                FileUtil.readFile("storage/emulated/0/nexzoWebIDE/theme/nexzoThemeapp.nexzo"),
      ...
      bin.web.setWebChromeClient(
          new WebChromeClient() {
            ...
            public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
              ...
              editor.setTypefaceText(Typeface.createFromAsset(getAssets(), "fonts/nexzofont.ttf"));
