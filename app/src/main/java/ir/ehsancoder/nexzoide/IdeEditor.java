...
import ir.ehsancoder.nexzoide.config.LOG;
import ir.ehsancoder.nexzoide.editor.EditorUtil;
import ir.ehsancoder.nexzoide.enums.EffectTypeManager;
import ir.ehsancoder.nexzoide.interfaces.CallBackErrorManager;
import ir.ehsancoder.nexzoide.marco.CommentList;
import ir.ehsancoder.nexzoide.marco.editorface.IEditor;
import ir.ehsancoder.nexzoide.widget.SymbolInputView;
...
public class IdeEditor extends CodeEditor implements IEditor {
  ...
  private static String A = "Made by ehsan coder";
  ...
  public IdeEditor init() {
    ...
    setNonPrintablePaintingFlags(FLAG_nexzoWEB | FLAG_Scrop);
