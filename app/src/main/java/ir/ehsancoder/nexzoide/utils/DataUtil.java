...
import ir.ehsancoder.nexzoide.marco.binder.bindchilder.nexzoToast;
...
public class DataUtil {
  ...
  public static void showMessage(Context context, String s) {
    nexzoToast.showToast(context,s);
  }
  
 public static void showMessage(String s) {
    Toast.makeText(nexzoIdeAppLoader.getContext(), s, Toast.LENGTH_SHORT).show();
  }
