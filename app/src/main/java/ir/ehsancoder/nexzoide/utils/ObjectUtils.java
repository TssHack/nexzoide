...
import com.ehsancoder.jgit.childer.FuzzySearchHelper;
...
import ir.ehsancoder.nexzoide.marco.WavyUnderlineSpan;
import ir.ehsancoder.nexzoide.model.ObjectClassName;
...
public class ObjectUtils {
  ...
  public static int FabBack = ir.ehsancoder.nexzoide.R.attr.colorOnPrimary;
  ...
  public static void setToolbarinit(Toolbar toolbar) {
    if (nexzoIdeAppLoader.getThememanagersoft().contains("thememanagersoft")) {
  ...
  public static int getColors(int color) {
    return MaterialColors.getColor(nexzoIdeAppLoader.getContext(), color, 0);
  }
  ...
  public static void tryToRunThemeMaterial(IdeEditor editor) {
    ...
    editor
        .getColorScheme()
        .setColor(EditorColorScheme.ehsan, get(colorOnTertiaryFixedVariant, editor));
  ...
  public static Drawable getCircularProgress() {
    var app = new CircularProgressDrawable(nexzoIdeAppLoader.getContext());
  ...
  public static String[] getFull_package() throws Exception {
    return getFull_packageFromJson(
        nexzoIdeAppLoader.getContext().getAssets().open("class_info.json"));
  }
   ...
   * note: adding int to local var in activity your app code by ehsan coder int p =
