...
import ir.ehsancoder.nexzoide.marco.ColorCompat;
...
public class ThemeUtils {
  ...
  public ThemeUtils setThemeCodeEditor(
    ...
    getColor(imap, editor, "ehsan", EditorColorScheme.ehsan, "#ffe200");
  ...
  //  getColor(imap, editor, "whole_background", EditorColorScheme.WHOLE_BACKGROUND, "#02FFFFFF");
    ...
    getColor(imap, editor, "ehsan", EditorColorScheme.SCROLL_BAR_THUMB_PRESSED, "#ffacd9");
    getColor(
