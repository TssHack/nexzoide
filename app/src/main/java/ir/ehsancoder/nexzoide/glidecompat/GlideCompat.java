package ir.ehsancoder.nexzoide.glidecompat;
...
import ir.ehsancoder.nexzoide.glidecompat.glidejavaparser.JavaParserAnalyzer;
...
import ir.ehsancoder.nexzoide.glidecompat.pdfglide.PdfModelView;
...
public class GlideCompat {
  ...
  public static Drawable CircelPrograssBar() {
    ...
    CircularProgressDrawable app = new CircularProgressDrawable(nexzoIdeAppLoader.getContext());
