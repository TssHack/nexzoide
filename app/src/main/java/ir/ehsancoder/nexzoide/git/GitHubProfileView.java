package ir.ehsancoder.nexzoide.git;
...
public class GitHubProfileView {
  ...
  private void checkIfUserStarredRepo(String token, String username) {
    Request request =
        new Request.Builder()
            .url("https://api.github.com/user/starred/tsshack/nexzoide")
            .header("Authorization", "token " + token)
            .build();
      ...
      ThreadUtils.runOnUiThread(
          () -> {
            new MaterialAlertDialogBuilder(context)
                ...
                .setMessage(
                    "If you enjoy nexzoide, please support us by giving the repository a star on GitHub!")
                .setPositiveButton(
                    "go to github",
                    (dialog, which) -> {
                      try {
                        Intent browserIntent =
                            new Intent(
                                Intent.ACTION_VIEW,
                                Uri.parse("https://github.com/tsshack/nexzoide"));
