package ir.ehsancoder.nexzoide.widget;
...
public class nexzoWebView extends WebView {
    ...
    public nexzoWebView(Context context) {
        super(context);
        init(context);
    }

    public nexzoWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public nexzoWebView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param fromUrl    the URL of the file to download, e.g. the one from `nexzoWebView.onDownloadRequested(...)`
    ...
    public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
        ...
        // if the download manager app has been disabled on the device
            ...
            openAppSettings(context, nexzoWebView.PACKAGE_NAME_DOWNLOAD_MANAGER);
