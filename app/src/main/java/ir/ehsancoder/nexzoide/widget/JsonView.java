...
/*
 *Fix all bug by ehsan coder .ir
 * این کتابخونه برای نکزو وب است
 * In library for nexzo web app
 */
...
public class JsonView extends LinearLayout {
    ...
    private void initView() {
        ...
        keyTV.setTypeface(Typeface.createFromAsset(mContext.getAssets(), "nexzofont.ttf"));
        valueTV.setTypeface(Typeface.createFromAsset(mContext.getAssets(), "nexzofont.ttf"));
        commandTV.setTypeface(Typeface.createFromAsset(mContext.getAssets(), "nexzofont.ttf"));
