...
public class PraramnetLayoutehsan extends LinearLayout {

    public PraramnetLayoutehsan(Context context) {
        super(context);
        init();
    }

    public PraramnetLayoutehsan(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init();
    }

    public PraramnetLayoutehsan(Context context, AttributeSet attributeSet, int labe) {
    ...
    public PraramnetLayoutehsan setBack(ColorStateList list) {
        if (list != null)
    ...
    public PraramnetLayoutehsan layoutAnim(int hsi, float[] colorlist) {
