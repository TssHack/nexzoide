...
public class nexzoWebCustomWebView extends WebView {

  public nexzoWebCustomWebView(Context context) {

    super(context);
    install();
  }

  public nexzoWebCustomWebView(Context context, AttributeSet attributeSet) {

    super(context, attributeSet);
    install();
  }

  public nexzoWebCustomWebView(Context context, AttributeSet attributeSet, int in) {
