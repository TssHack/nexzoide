...
public class FileEnvironmentHelper {
  ...
  public nexzoTheme nexzo() {
    return new nexzoTheme(this);
  }
  ...
  public ehsanProjectHelper ehsanprojects() {
    return new ehsanProjectHelper(this);
  }
  ...
  public boolean isehsanProjectx() {
    return isFileHasKeyName(filePath, "apps", false, false)
        || isFileHasKeyName(filePath, "ehsans", false, false);
  }

  public boolean isAppIcon() {
    return isFileHasKeyName(filePath, "nexzoWebIDE", false, false)
        || isFileHasKeyName(filePath, "nexzoweb", false, false);
  }
  ...
  public static class nexzoTheme {
    protected FileEnvironmentHelper instance;

    public nexzoTheme(FileEnvironmentHelper instance) {
      this.instance = instance;
    }

    public boolean isnexzoFile() {
      return nexzoDetector.isnexzoFile(instance.filePath);
    }

    public boolean isAppLego() {
      return nexzoDetector.isAppLoaderTheme(instance.filePath);
    }
  }
  ...
  public static class ehsanProjectHelper {
    private FileEnvironmentHelper ev;

    public ehsanProjectHelper(FileEnvironmentHelper ev) {
      this.ev = ev;
    }

    public boolean isehsanDev() {
      return ehsanProjectDetector.isehsanLang(ev.filePath);
    }
  }
}
