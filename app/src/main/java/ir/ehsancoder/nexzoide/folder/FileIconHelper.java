...
public class FileIconHelper {
  ...
  private void setupFolderIcons() {
    ...
    if (isDynamicFolderEnabled) {
      if (isEnvironmentEnabled) {
        ...
        else if (fileEnvHelper.nexzo().isnexzoFile()) fileIconRes = R.drawable.app_icon;
        else if (fileEnvHelper.nexzo().isAppLego()) fileIconRes = R.drawable.vector_folder_nexzoweb;
        else if (fileEnvHelper.ehsanprojects().isehsanDev()) fileIconRes = R.drawable.nexzoicons;
      } else {
        ...
        else if (fileEnvHelper.isAppIcon()) fileIconRes = R.drawable.vector_folder_nexzoweb;
        ...
        else if (fileEnvHelper.isehsanProjectx()) fileIconRes = R.drawable.nexzoiconred;
  ...
  private void setupFileIcons() {
    ...
    else if (is("nexzo")) fileIconRes = R.drawable.nexzofile;
