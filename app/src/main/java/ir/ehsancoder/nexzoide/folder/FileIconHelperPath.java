...
public class FileIconHelperPath {
  ...
  public static final String ICON_PATH = "/storage/emulated/0/nexzoWebIDE/appicon";
  ...
  private void initializeFolderUtils() {
    folderUtils = FolderUtils.getInstance(nexzoIdeAppLoader.getContext());
    folderUtils.setIconsBasePath("/storage/emulated/0/nexzoWebIDE/appicon/");
    folderUtils.loadFileIcons("/storage/emulated/0/nexzoWebIDE/appicon/file_icons.json");
    folderUtils.loadFolderIcons("/storage/emulated/0/nexzoWebIDE/appicon/folder_icons.json");
  }
  ...
  public void bind(ImageView imageView) {
    try {
      ...
      Toast.makeText(nexzoIdeAppLoader.getContext(),e.getMessage(),2).show();
    }
  }
