...
public class AS {
  ...
  public static final String THEMEPATH = "/storage/emulated/0/nexzoWebIDE/theme/";
  ...
  private static String getOutputFileName(String inputFileName) {
    ...
    if (extensionIndex != -1) {
      return inputFileName.substring(0, extensionIndex) + "_signedbynexzoWeb.apk";
    } else {
      return inputFileName + "_signedbynexzoWeb.apk";
    }
  }
