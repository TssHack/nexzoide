...
import ir.ehsancoder.nexzoide.databinding.LayoutSearcherBinding;
...
public class nexzoWebEditorSearch extends LinearLayout {
  ...
  public nexzoWebEditorSearch(Context context) {
    this(context, null);
  }

  public nexzoWebEditorSearch(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public nexzoWebEditorSearch(Context context, AttributeSet attrs, int defStyle) {
