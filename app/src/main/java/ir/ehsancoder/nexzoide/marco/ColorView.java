...
import ir.ehsancoder.nexzoide.adapter.ColorRenderAdapter;
import ir.ehsancoder.nexzoide.adapter.JavaASmailAd;
import ir.ehsancoder.nexzoide.config.ChlidJavaList;
import ir.ehsancoder.nexzoide.interfaces.JavaParserCallBack;
...
/**
 * This class is made by ehsan Kader for various navigation functions, from the sample color of XML
 * tags and ...
 */
    ...
    menu.setOnMenuItemClickListener(
        (itemPos, cc) -> {
          ...
          switch (item) {
            case 0 -> {
              String get = path;
              get = "/storage/emulated/0/nexzoWebIDE/";
