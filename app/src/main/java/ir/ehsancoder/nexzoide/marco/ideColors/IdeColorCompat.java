package ir.ehsancoder.nexzoide.marco.ideColors;
...
import ehsan.coder.appuploader.utils.ShapeName;
import ehsan.coder.appuploader.utils.ShapeUtils;
...
public class IdeColorCompat {
  ...
  public void setIconLang(String path, ImageView icon) {
    ...
    if (path.endsWith(".css")) {
      ...
      icon.setImageResource(R.drawable.nexzofile);
      ...
      icon.setImageResource(R.drawable.vector_folder_nexzoweb);
