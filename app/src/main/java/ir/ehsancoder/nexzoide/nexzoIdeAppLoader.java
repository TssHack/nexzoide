...
import ir.ehsancoder.nexzoide.activities.ErrorManagerActivity;
...
import ir.ehsancoder.nexzoide.utils.MobileInfo;
...
public class nexzoIdeAppLoader extends Application {
  // from terminal
  // recreate()
  ...
  private static nexzoIdeAppLoader loader;
  ...
  public static nexzoIdeAppLoader getInstance() {
    return loader;
  }
