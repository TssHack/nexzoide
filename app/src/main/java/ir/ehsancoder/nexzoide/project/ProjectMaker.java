package ir.ehsancoder.nexzoide.project;

import android.text.TextWatcher;
import ir.ehsancoder.nexzoide.R;
import ir.ehsancoder.nexzoide.compressor.SvgToPng;
import ir.ehsancoder.nexzoide.databinding.LayoutSvgSizeFiledirBinding;
import ir.ehsancoder.nexzoide.databinding.ProjectsBinding;
import ir.ehsancoder.nexzoide.tasks.AsyncTaskCompat;
import ir.ehsancoder.nexzoide.tasks.app.ProgressDialogCompat;
import ir.ehsancoder.nexzoide.utils.Decompress;
...
public class ProjectMaker {
  ...
  public void setMakeHtmlProject() {
    ...
    AlertDialog dialog =
        new nexzoWebMaterialDialog(context)
