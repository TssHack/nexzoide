package ir.ehsancoder.nexzoide.model;

import ir.ehsancoder.nexzoide.R;
import ir.ehsancoder.nexzoide.adapter.IconManagerAdapter;
...
// rewinter code by ehsan coder and appt2

public class IconShop {
  protected Context context;
  protected String path = "/storage/emulated/0/nexzoWebIDE/.icon";
        ...
        (pos, __) -> {
          switch (pos) {
            case 0:
              ...
              VectorHelper.projectResourceDirectory = "/storage/emulated/0/nexzoweb/icon/vector/";
              VectorHelper.v(
