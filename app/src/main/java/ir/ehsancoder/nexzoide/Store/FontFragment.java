...
import ir.ehsancoder.nexzoide.Store.FontManager;
...
public class FontFragment extends Fragment {
  ...
  private String link =
      "https://raw.githubusercontent.com/tsshack/nexzofont/refs/heads/main/github_font.json";
    ...
    ThreadUtils.executeByIo(
        new ThreadUtils.SimpleTask<File>() {
          ...
          public File doInBackground() throws Throwable {
            ...
            File downloadsDir = new File("/storage/emulated/0/nexzoWebIDE/font/");
