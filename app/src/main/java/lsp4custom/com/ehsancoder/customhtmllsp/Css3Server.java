package lsp4custom.com.ehsancoder.customhtmllsp;
...
public class Css3Server {
  ...
  void toMaterialize(List<CompletionItem> list, String prefix) throws Exception {
    ...
    var inputStream = nexzoIdeAppLoader.getContext().getAssets().open("materialize.min.css");
  ...
  void toAndroidAttr(List<CompletionItem> list, String prefix) throws Exception {
    ...
    var openFile = nexzoIdeAppLoader.getContext().getAssets().open("android.R.attrs.json");
