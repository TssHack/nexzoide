...
import ir.ehsancoder.nexzoide.marco.RegexUtilCompat;
...
import ir.ehsancoder.nexzoide.widget.data.CSSVariableParser;
      ...
      while (delegate.shouldAnalyze()) {
        ...
        switch (type) {
          ...
          case HTMLLexer.IDENTIFIER:
            {
              ...
              if (previous == HTMLLexer.AT) {
                colorid = EditorColorScheme.ehsan;
              }
          ...
          case HTMLLexer.LinkLiteral:
            Span span =
                Span.obtain(
                    column, TextStyle.makeStyle(EditorColorScheme.ehsan, 0, true, true, false));
            result.addIfNeeded(line, column, EditorColorScheme.ehsan);
