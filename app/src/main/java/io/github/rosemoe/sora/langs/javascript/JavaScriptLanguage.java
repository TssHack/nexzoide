...
import ir.ehsancoder.nexzoide.widget.data.JsBeautify;
...
public class JavaScriptLanguage implements EditorLanguage {
  ...
  public JavaScriptLanguage() {
    Toast.makeText(nexzoIdeAppLoader.getContext(), "Start Server Language", 2).show();
  }
  ...
  public CharSequence format(CharSequence text) {
    try {
      return JavaScriptCodeFormatter.formatJavaScriptCode(nexzoIdeAppLoader.getContext(),text.toString());
    } catch (Exception err) {
      return text;
    }
  }
