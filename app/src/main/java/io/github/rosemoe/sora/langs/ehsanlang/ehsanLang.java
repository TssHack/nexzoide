...
import io.github.rosemoe.sora.langs.ehsanlang.server.ServerHot;
import java.io.StringReader;

import org.antlr.v4.runtime.CharStreams;
import org.antlr.v4.runtime.Token;
import io.github.rosemoe.sora.langs.ehsanlang.server.ehsanAuto;
...
public class ehsanLang implements EditorLanguage {
  ...
  public AutoCompleteProvider getAutoCompleteProvider() {
      var ehsanorator = new KotilnAutoText();
      ehsanorator.setKeywords(ServerHot.keys);
    return ehsanorator;
  }
