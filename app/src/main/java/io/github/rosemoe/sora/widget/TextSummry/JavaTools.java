...
import ir.ehsancoder.nexzoide.config.CreatorComment;
import ir.ehsancoder.nexzoide.config.GetterSetterGenerator;
import ir.ehsancoder.nexzoide.config.JavaPaserUtils;
import ir.ehsancoder.nexzoide.databinding.MakefolderBinding;
import ir.ehsancoder.nexzoide.marco.ActivityToFragmentConverter;
import ir.ehsancoder.nexzoide.marco.LicenseManagerImpl;
import ir.ehsancoder.nexzoide.marco.editorface.ConstructorMaker;
...
import io.github.rosemoe.sora.widget.schemes.nexzoThemeDark;
...
public class JavaTools {
  ...
  public void installextractJavaClass(Context c, CodeEditor editor, String text) {
    ...
    myeditor.setColorScheme(new nexzoThemeDark());
