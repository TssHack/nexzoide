...
import lsp4custom.com.ehsancoder.customhtmllsp.JavaCardshorts;
import lsp4custom.com.ehsancoder.customhtmllsp.TypeScriptCardshorts;
...
public class JavaAutoComplete implements AutoCompleteProvider {
  ...
  public JavaAutoComplete(IdeEditor editor) {
    ...
    shp = nexzoIdeAppLoader.getContext().getSharedPreferences("shp", Context.MODE_PRIVATE);
  }
