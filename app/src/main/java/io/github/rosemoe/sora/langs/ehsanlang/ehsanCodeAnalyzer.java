...
import io.github.rosemoe.sora.langs.ehsanlang.server.ehsanTextTokenizer;
...
import org.antlr.parser.antlr4.ehsan.ehsanTest;

/**
 * @author ehsancoder
 */
public class ehsanCodeAnalyzer implements CodeAnalyzer {
  ...
  public void analyze(
    ...
    var tokenizer = new ehsanTextTokenizer(text);
    ...
    identifiers.finish();
    ehsanTest.main(result,content.toString());
