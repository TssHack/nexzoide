...
import ir.ehsancoder.nexzoide.activities.BrowserActivity;
import ir.ehsancoder.nexzoide.activities.CodeEditorActivity;
import ir.ehsancoder.nexzoide.databin.XmlTranslator;
import ir.ehsancoder.nexzoide.marco.SmaliHelper;
import ir.ehsancoder.nexzoide.tasks.SmalitoJava;
import ir.ehsancoder.nexzoide.utils.ObjectUtils;
import ir.ehsancoder.nexzoide.adapter.Recyclerview0Adapter;
...
public class ToolItem {
  ...
  public void MakeItemehsanLang(Context context, CodeEditor editor) {
  ...
  public void BindViewsehsan(Context context, View view, CodeEditor editor) {
    PowerMenu menu =
    ...
    menu.setHeaderView(getCustomHader("ehsan Helper", context));
    menu.setOnMenuItemClickListener(
        (pos, item) -> {
          if (pos == 0) {
            MakeItemehsanLang(context, editor);
          } else if (pos == 1) {
