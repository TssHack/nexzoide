...
import ir.ehsancoder.nexzoide.adapter.TextActionAd;
import ir.ehsancoder.nexzoide.databinding.TextComposePopupWindowBinding;
import ir.ehsancoder.nexzoide.marco.EditorSearcherT;
import ir.ehsancoder.nexzoide.marco.SmaliHelper;
import ir.ehsancoder.nexzoide.model.TextActionModel;
                                        ...
                                        case 7:
                                            {
                                                if (editor.getEditorLanguage()
                                                        instanceof ehsanLang) {
                                                    ToolItem item = new ToolItem();
                                                    item.BindViewsehsan(v.getContext(), v, editor);
