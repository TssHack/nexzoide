...
import ir.ehsancoder.nexzoide.tasks.app.HtmlToCssGenerator;
...
import ir.ehsancoder.nexzoide.marco.HtmlTagView;
...
import ir.ehsancoder.nexzoide.widget.data.ColorChecker;
import java.io.File;
    ...
    menu.setOnMenuItemClickListener(
        (pos, __) -> {
          if (pos == 0) {
            ...
            var it = nexzoIdeAppLoader.getShap();
