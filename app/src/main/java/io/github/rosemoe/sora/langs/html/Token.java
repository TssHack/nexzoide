...
public enum Token {
    ...
    GETELEMENTBYID,
    GETELEMENTBYCLASS,
    // attr html 5 nexzo web full mode
    // tnks for ehsan coder this in code for nexzoweb ide dont using for other apps tnks
    // this code form nexzo web ide 1.5.7 static mod
    ACCEPT,
    ACCESSKEY,
    ACTION,
    ALIGN,
