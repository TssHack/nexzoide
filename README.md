...
<div align="center">
  <h3>Nexzo IDE - Fast Editor for Android</h3>
</div>

<p align="center">
  <img src="https://raw.githubusercontent.com/tsshack/nexzoide/refs/heads/main/nexzo%20ide.svg" alt="Nexzo IDE Logo" width="150">
</p>

![GitHub stars](https://img.shields.io/github/stars/tsshack/Nexzoide?style=social)
![GitHub forks](https://img.shields.io/github/forks/tsshack/Nexzoide?style=social)
![GitHub release](https://img.shields.io/github/v/release/tsshack/Nexzoide)
![Commit Activity](https://img.shields.io/github/commit-activity/m/tsshack/Nexzoide)
[![GitHub contributors](https://img.shields.io/github/contributors/tsshack/Nexzoide)](https://github.com/tsshack/Nexzoide/graphs/contributors)
[![GitHub last commit](https://img.shields.io/github/last-commit/tsshack/Nexzoide)](https://github.com/tsshack/Nexzoide/commits/)
...
- Unlike other programs, Nexzo IDE is very lightweight. We want you to have all the files in one place so you don't need to download them again.

### Store
- It doesn't matter if you are a programmer or not, you can contribute to this repository [this](https://github.com/tsshack/nexzotheme)and share your own themes Just don't forget to add your theme and preview to the main json of the repository after you're done uploading it.
- We have also created a background store[this](https://github.com/tsshack/Nexzoidewallpapaer) for you, so if you need variety, you can download the background or even set it for the editor code. You just need to uncolor the following keys 1: `line_number_background` 2: `whole_background` 3: `backgroundcolorlinear`
- We also created a font store for your taste [this](https://github.com/tsshack/nexzofont), which includes Iranian and foreign fonts. Nexzoide serves you because it was created to serve.

### Custom Theme
- You can learn how to create a theme here [click](https://github.com/tsshack/nexzotheme)
...
We invite you to collaborate on nexzo IDE under the following conditions:
...
- This is an open-source project under the **Nexzo Web** brand.

---

### Code Snippets

Nexzo IDE supports code snippets. Here's an example:
...
#### Note:
You can name your snippets with lowercase English letters, as in the examples above. In the future, all languages supported by Nexzo IDE will support this feature.

---

### Physical Keyboard Shortcuts

Nexzo IDE offers a variety of keyboard shortcuts for physical keyboards from FileManager Activity:
